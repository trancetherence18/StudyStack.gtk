...
class FlashcardApp:
    ...
    def main_window(self):
        ...
        self.card_frame = tk.Frame(self.root, width=800, height=280, bg=CARD_FRAME_BG,
                                   bd=3, relief="raised")
        self.card_frame.pack(pady=10)
        self.card_frame.pack_propagate(False)

        self.card_label = tk.Label(self.card_frame, text="", font=CARD_FONT_STYLE,
                                   bg=CARD_LABEL_BG, fg=TEXT_COLOR, wraplength=700)
        ...
        self.answer_entry = tk.Entry(input_frame, width=42, font=("Helvetica", 20))
        self.answer_entry.grid(row=0, column=7, padx=12)

        submit_btn = tk.Button(self.root, text="SUBMIT ANSWER",
                               font=FONT_STYLE, bg=SUBMIT_COLOR, fg="white",
                               width=32, height=2, command=self.submit_answer)
